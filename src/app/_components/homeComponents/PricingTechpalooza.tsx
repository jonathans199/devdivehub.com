...
export function PricingTechpalooza() {
	return (
		<div className=' py-24 sm:py-32'>
			<div className='mx-auto max-w-7xl px-6 lg:px-8'>
				<div className='mx-auto max-w-4xl text-center'>
					<h2 className='text-white-600 text-base font-semibold leading-7'>Pricing</h2>
					<p className='mt-2 text-4xl font-bold tracking-tight text-white sm:text-5xl'>
						Tickets are available, with prices increasing on June 30 and August 31.
					</p>
				</div>
						...
						<div
							...
							<div>
								...
								<p className='mt-6 flex items-baseline gap-x-1'>
									...
									<span className='text-sm font-semibold leading-6 text-gray-600'>/per person</span>
								</p>
							...
							<a
								...
								className={classNames(
									...
									'mt-8 block rounded-md px-3 py-2 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600'
								)}>
								Buy plan
							</a>
						</div>
