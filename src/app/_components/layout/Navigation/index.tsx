  ...
  return (
    <div className="sticky top-0 z-50 w-auto">
      {/* <div className="bg-gray-900">
        <div className="container py-2 text-right text-xs">
          <a href="tel:+13054776612">( 305 ) 477-6612 </a> &nbsp; | &nbsp;
          <a href="mailto:sales@icpmiami.com"> sales@icpmiami.com </a> 
          <span className='hidden md:inline'>mon-fri / 9am to 5pm </span>
        </div>
      </div> */}
                ...
                <div className="flex items-center px-2 lg:px-0">
                  <a className="flex-shrink-0" href="/">
                    <img
                      ...
                      src="/img/logos/southfloridatechhub-logo.png"
